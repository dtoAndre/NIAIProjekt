...
def str_check_landscape(pos_x, pos_y, comp, tile_type):
    return f"landscape[11+({pos_y}), 11+({pos_x})] {comp} {tile_type}"
...
#pset.addPrimitive(str_check_landscape, [int, int, str, int], Condition)
...
pset.addTerminal("1", Position)
pset.addTerminal("==", Comparator)
pset.addTerminal("!=", Comparator)
#Sprites
pset.addTerminal("Sprite.KIND_GOOMBA", EnemyType)
pset.addTerminal("Sprite.KIND_RED_KOOPA", EnemyType)
pset.addTerminal("Sprite.KIND_GREEN_KOOPA", EnemyType)
pset.addTerminal("Sprite.KIND_SPIKY", EnemyType)
pset.addTerminal("Sprite.KIND_BULLET_BILL", EnemyType)
